    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        readBtn.setOnClickListener(view -> {
            ...
            Thread classificationThread = new Thread(() -> {
                ...
                this.runClassification(trees, ownerData, otherData);
                try {
...
// notificationId is a unique int for each notification that you must define
                    notificationManager.notify(3423, builder.build());
                }
            }
        }, intentFilter);
    }
    ...
    private void startCollecting() {
        Intent intent = new Intent(TestActivity.this, CollectService.class);
    ...
    private void runClassification(Classifier classifier, List<DataWindowDto> ownerData, List<DataWindowDto> otherData) {
        File dataFile = FileUtil.createDataFile(getFilesDir().getAbsolutePath(), ownerData, otherData);
